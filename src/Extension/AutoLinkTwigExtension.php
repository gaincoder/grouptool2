...
class AutoLinkTwigExtension extends \Twig\Extension\AbstractExtension
{

    public function getFilters()
    {
        return array('auto_link_text' => new \Twig\TwigFilter('auto_link_text', $this, array('is_safe' => array('html'))),
        );
    }
