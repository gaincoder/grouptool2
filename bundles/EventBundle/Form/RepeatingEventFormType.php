...
class RepeatingEventFormType extends AbstractType
{
    ...
    {
        $builder
            ->add('start', DateTimeType::class, array('label' => false, 'required' => true, 'date_widget' => 'single_text',
