...
/**
 * @ORM\Entity(repositoryClass="PollBundle\Repository\PollAnswer")
 */
class PollAnswer
{
    /**
    ...
    /**
     * @var Poll
     * @ORM\ManyToOne(targetEntity="PollBundle\Entity\Poll",inversedBy="answers")
     */
    public $poll;

    /**
     * @var UserVote[]
     * @ORM\OneToMany(targetEntity="PollBundle\Entity\UserVote",mappedBy="answer",cascade={"persist","remove"})
     */
    public $votes;
